...
output_folder = "/Users/mhm/Desktop/FONDECYT_CAMILA/mhm_snow/DATA/RAST/LAI"  # Windows
...
# %% explore dates
mod15_lastimg = ee.ImageCollection("JAXA/GCOM-C/L3/LAND/LAI/V3").sort('system:time_start', False).first()
...
aoi_path = "/Users/mhm/Desktop/FONDECYT_CAMILA/mhm_snow/DATA/SHP/Chile_Polygon.geojson"  # Replace with your file path
...
modis_terra = ee.ImageCollection("JAXA/GCOM-C/L3/LAND/LAI/V3").filterDate(start_date, end_date).select("LAI_AVE")

# Merge both collections
modis_combined = modis_terra
...
export_task = ee.batch.Export.image.toDrive(
    ...
    folder="LTM_JAXA_LAI_V3",
    fileNamePrefix="JAXA_LongTerm_Monthly_LAI",
    scale=5000,
    region=aoi,
    fileFormat="GeoTIFF",
    maxPixels=1e13
