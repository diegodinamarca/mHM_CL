...
soil_folder = r"C:/Users/rappe/OneDrive/Documentos/FONDECYT_CAMILA/mhm_snow/DATA/RAST/Soil/SoilMaps_MEAN"
morph_folder = r"C:/Users/rappe/OneDrive/Documentos/FONDECYT_CAMILA/mhm_snow/PROC/morph"
roi_file = "C:/Users/rappe/OneDrive/Documentos/FONDECYT_CAMILA/mhm_snow/DATA/SHP/Cuencas/cuencas_grupos/grupo6.geojson"  # puede ser .shp o .geojson
cellsize = 0.001953125
horizons = ["0-5", "5-15", "15-30", "30-60", "60-100", "100-200"]
nodata_fill = -9999
remove_temp = False          # elimina el contenido de temp/ al final
...
for idx, hz in enumerate(horizons):
    ...
    clay, nodata_c, _        = read_clip_and_resample_raster(clay_path, shapes, cellsize, Resampling.nearest)
    sand, nodata_s, _        = read_clip_and_resample_raster(sand_path, shapes, cellsize, Resampling.nearest)
